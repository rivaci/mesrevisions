// Chapitre 1, savoir-faire 1 — Reconnaître une configuration de Thalès.
//
...
// ── Ce que la 3e ajoute ──────────────────────────────────────────────────
//
// La configuration « PAPILLON », que le programme de 4e écartait. Le théorème
// y est rigoureusement le même ; ce qui change, c'est que la figure ne
// ressemble plus à celle du cours. D'où deux erreurs symétriques, et le
// savoir-faire les vise toutes les deux : appliquer le théorème à un papillon
...
export default {
  ...
  attendus: [
    ...
    'Il distingue les triangles emboîtés de la configuration « papillon », et sait que le théorème s\'applique aux deux.',
  ],
  ...
  cours: [
    ...
    },
    {
      ...
      texte:
        'Même point commun, mêmes deux droites, mais les deux points sont **de '
        + 'part et d\'autre** de ce point au lieu d\'être du même côté. Les deux '
        + 'triangles se font alors face, pointe contre pointe — d\'où le nom.\n'
    ...
    },
    {
      ...
      texte:
        ...
        + 'parallèles ?\n'
        + 'Si l\'une des trois manque, le théorème ne s\'applique pas. Et si les '
        + 'trois sont là, il s\'applique — même si la figure ne ressemble pas à '
        + 'celle du cours. Une ressemblance ne remplace aucune des trois '
        + 'conditions, et une non-ressemblance n\'en supprime aucune.',
    },
    {
      type: 'remarque',
      titre: 'Le papillon n\'est pas un autre théorème',
      texte:
        'C\'est le même, avec la même démonstration et les mêmes quotients. La '
        + 'seule différence est le **dessin** : les deux triangles se font face '
        + 'au lieu d\'être rangés l\'un dans l\'autre.\n'
        + 'Le risque n\'est donc pas de se tromper de formule, c\'est de **ne pas '
        + 'reconnaître** la figure et de renoncer alors qu\'on avait le droit. '
        + 'Devant un papillon valide, on écrit exactement les mêmes rapports que '
        + 'devant des triangles emboîtés.',
    },
    {
      type: 'exemple',
      texte:
  ...
  entrainement: [
    ...
    {
      id: 'e-1-1-1', type: 'vraifaux', palier: 1, piege: 'configuration-non-verifiee',
    ...
    },
    {
      ...
      id: 'e-1-1-2', type: 'plausible', palier: 1, neutre: true, piege: 'thales-sans-parallelisme',
    ...
    },
    {
      ...
      id: 'e-1-1-3', type: 'plausible', palier: 1, piege: 'thales-sans-parallelisme',
      consigne: 'Ce résultat est-il plausible ?',
      enonce:
    ...
    {
      id: 'e-1-1-4', type: 'vraifaux', palier: 1, piege: 'thales-sans-parallelisme',
    ...
    {
      id: 'e-1-1-5', type: 'vraifaux', palier: 2, piege: 'configuration-non-verifiee',
      consigne: 'Vrai ou faux ?',
    ...
    {
      id: 'e-1-1-6', type: 'plausible', palier: 2, piege: 'thales-sans-parallelisme',
      consigne: 'Ce résultat est-il plausible ?',
      enonce:
    ...
    },
    {
      ...
      id: 'e-1-1-7', type: 'plausible', palier: 2, neutre: true, piege: 'thales-sans-parallelisme',
      consigne: 'Ce résultat est-il plausible ?',
      enonce:
    ...
    {
      id: 'e-1-1-8', type: 'trous', palier: 2, piege: 'rapports-mal-apparies',
      consigne:
        'Les droites (BC) et (DE) sont parallèles. A, B, D sont alignés dans cet '
    ...
    {
      id: 'e-1-1-9', type: 'corriger', palier: 3, piege: 'thales-sans-parallelisme',
    ...
    {
      id: 'e-1-1-10', type: 'vraifaux', palier: 3, piege: 'aire-et-rapport-confondus',
      consigne: 'Vrai ou faux ? Si c\'est faux, donne un contre-exemple.',
    ...
    {
      // Le papillon VALIDE. L'erreur visée n'est pas l'excès de confiance mais
      // le renoncement : la figure ne ressemble pas au cours, donc l'élève
      // croit que le théorème ne s'applique pas. Les trois conditions y sont.
      id: 'e-1-1-11', type: 'plausible', palier: 2, piege: 'configuration-non-verifiee',
      consigne: 'Ce résultat est-il plausible ?',
      enonce:
      ...
      attendu: true,
      explication:
        'C\'est un papillon : A est entre B et D, et entre C et E. Mais le '
        + 'sommet commun, les deux alignements et le parallélisme sont bien là, '
        + 'donc le théorème s\'applique exactement comme pour des triangles '
        + 'emboîtés. Et les quotients concordent : 3 ÷ 9 et 4 ÷ 12 valent tous '
        + 'les deux un tiers.',
    },
    {
      // Item jumeau du précédent, papillon lui aussi, mais le parallélisme a
      // disparu. Sans lui, « papillon donc ça marche » remplacerait simplement
      // « papillon donc ça ne marche pas ».
      id: 'e-1-1-12', type: 'plausible', palier: 3, piege: 'thales-sans-parallelisme',
      consigne: 'Ce résultat est-il plausible ?',
      enonce:
        '\\text{B, A, D alignés dans cet ordre ; C, A, E alignés dans cet ordre ; l\'énoncé ne dit rien des droites (BC) et (DE).} '
        + '\\quad \\text{AB = 3 cm, AD = 9 cm, AC = 4 cm, donc AE = 12 cm}',
      attendu: false,
      explication:
        'La configuration en papillon est bien là, mais elle ne suffit pas : '
        + 'c\'est le parallélisme qui rend les quotients égaux, dans les deux '
        + 'configurations. Sans lui, AE pourrait mesurer 12 cm comme tout autre '
        + 'chose.',
    },
  ],
  ...
  test: [
    ...
    {
      id: 't-1-1-4', type: 'vraifaux',
      consigne: 'Vrai ou faux ?',
      affirmation: 'Le théorème de Thalès s\'applique aussi bien quand les deux points sont de part et d\'autre du sommet commun que lorsqu\'ils sont du même côté.',
      attendu: true, revoir: 'remarque',
    },
    {
      id: 't-1-1-5', type: 'trous',
      consigne:
