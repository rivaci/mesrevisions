...
const APPLI = 'maths3e';
const CLE_DISCIPLINAIRE = 'maths3e.memoire.v1';
const MAX_NOTES = 6;
...
const consignes = (prenom) => `Tu t'appelles Merlin. Tu es le professeur particulier de ${prenom}, 13 ans, en 3e, qui reprend chaque chapitre au fur et à mesure qu'il le voit en classe et prépare le brevet.
