  ...
  app.append(html(`
    <header class="entete">
      ...
      <div class="entete-titre">
        ...
        <p>Français 3<sup>e</sup>, au fil des cours</p>
      </div>
    ...
    ${ia.disponible() ? `
      <a class="carte-merlin" href="#/merlin">
        ...
        <span class="carte-merlin-texte">
          ...
          <span>Une question de grammaire ? Il t'explique.</span>
        </span>
...
function merlin() {
  ...
  app.append(html(`${enTete}
    <p class="merlin-intro">Pose ta question sur la grammaire, la nature des mots, l'orthographe, le sens d'une phrase…
...
function exporterBilan() {
  const profil = store.profil();
  const lignes = [
    `SUIVI ${eleve.de().toUpperCase()} — FRANÇAIS 3e`,
