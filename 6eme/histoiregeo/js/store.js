...
export const BADGES = [
  ...
  { id: 'cartographe', nom: 'Cartographe', icone: '🌍', description: 'Placer les six continents', gagne: () => tousAcquisDe('continents-carte') },
  { id: 'navigateur', nom: 'Navigateur', icone: '🌊', description: 'Placer les cinq océans', gagne: () => tousAcquisDe('oceans-carte') },
  { id: 'geometre', nom: 'Géomètre', icone: '📐', description: 'Placer les lignes imaginaires', gagne: () => tousAcquisDe('lignes-carte') && tousAcquisDe('lignes-familles') },
  { id: 'lecteur-de-cartes', nom: 'Lecteur de cartes', icone: '🧭', description: "Maîtriser la rose des vents, l'échelle et la légende", gagne: () => tousAcquisDe('rose-des-vents') && tousAcquisDe('outils-carte') && tousAcquisDe('echelle-calcul') },
  { id: 'mare-nostrum', nom: 'Mare nostrum', icone: '🏛️', description: 'Placer les six villes de la Méditerranée', gagne: () => tousAcquisDe('villes-carte') },
  { id: 'chronologue', nom: 'Chronologue', icone: '🕰️', description: 'Maîtriser les cinq grandes périodes', gagne: () => tousAcquisDe('periodes-ordre') && tousAcquisDe('periodes-dates') && tousAcquisDe('periodes-bornes') },
  { id: 'romain', nom: 'Ave Caesar', icone: 'Ⅹ', description: 'Lire et écrire les chiffres romains', gagne: () => tousAcquisDe('romains-lire') && tousAcquisDe('romains-ecrire') },
  { id: 'siecles', nom: 'Maître du temps', icone: '📜', description: "Trouver le siècle de n'importe quelle date", gagne: () => tousAcquisDe('siecles') },
