...
const APPLI = 'maths4e';
const CLE_DISCIPLINAIRE = 'maths4e.memoire.v1';
const MAX_NOTES = 6;
...
const consignes = (prenom) => `Tu t'appelles Merlin. Tu es le professeur particulier de ${prenom}, 13 ans, qui entre en 3e et révise son programme de 4e.
