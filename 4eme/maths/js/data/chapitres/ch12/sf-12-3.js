// Chapitre 12, savoir-faire 3 — Démontrer que deux droites sont parallèles.
//
...
//
// La configuration « papillon » et les triangles semblables sont en 3e : rien
// ici ne sort des triangles emboîtés.
...
export default {
  ...
  cours: [
    ...
    },
    {
      ...
      texte:
        'En 4e, cette réciproque ne s\'utilise que dans la configuration des '
        + '**triangles emboîtés** : un **sommet commun**, et les deux autres '
        + 'sommets de chaque triangle portés par les mêmes droites.\n'
        + 'Deux quotients égaux ne suffisent pas si les triangles n\'ont pas ce '
        + 'sommet commun.',
    },
    {
      type: 'remarque',
  ...
  entrainement: [
    ...
    {
      id: 'e-12-3-1', type: 'calcul', palier: 1, piege: 'rapports-mal-apparies',
      consigne:
    ...
    {
      id: 'e-12-3-2', type: 'calcul', palier: 1, piege: 'rapports-mal-apparies',
    ...
    },
    {
      ...
      id: 'e-12-3-3', type: 'comparer', palier: 1, neutre: true, piege: 'thales-sans-parallelisme',
    ...
    },
    {
      ...
      id: 'e-12-3-4', type: 'comparer', palier: 1, piege: 'thales-sans-parallelisme',
      consigne:
    ...
    {
      id: 'e-12-3-5', type: 'plausible', palier: 2, piege: 'thales-sans-parallelisme',
    ...
    },
    {
      ...
      id: 'e-12-3-6', type: 'plausible', palier: 2, neutre: true, piege: 'thales-sans-parallelisme',
      consigne: 'Ce résultat est-il plausible ?',
      enonce:
    ...
    {
      id: 'e-12-3-7', type: 'trous', palier: 2, piege: 'rapports-mal-apparies',
      consigne:
        'Les points A, B, D sont alignés dans cet ordre, ainsi que A, C, E. On '
    ...
    {
      id: 'e-12-3-8', type: 'corriger', palier: 3, piege: 'thales-sans-parallelisme',
    ...
    },
    {
      ...
      id: 'e-12-3-9', type: 'plausible', palier: 3, piege: 'configuration-non-verifiee',
      consigne: 'Ce résultat est-il plausible ?',
      enonce:
    ...
    {
      id: 'e-12-3-10', type: 'vraifaux', palier: 3, piege: 'thales-sans-parallelisme',
  ...
  test: [
    {
      id: 't-12-3-1', type: 'comparer', consigne: 'Compare ces deux quotients.',
      enonce: '\\dfrac{2}{5} \\ldots \\dfrac{6}{15}', attendu: '=', revoir: 'theoreme',
    },
    {
      id: 't-12-3-2', type: 'comparer', consigne: 'Compare ces deux quotients.',
      enonce: '\\dfrac{3}{7} \\ldots \\dfrac{5}{11}', attendu: '<', revoir: 'propriete',
    },
    {
      id: 't-12-3-3', type: 'fraction',
      consigne:
    ...
    {
      id: 't-12-3-5', type: 'plausible', consigne: 'Ce résultat est-il plausible ?',
      enonce:
    ...
    {
      id: 't-12-3-6', type: 'comparer', consigne: 'Compare ces deux quotients.',
      enonce: '\\dfrac{9}{12} \\ldots \\dfrac{15}{20}', attendu: '=', revoir: 'theoreme',
    },
    {
      id: 't-12-3-7', type: 'plausible', consigne: 'Ce résultat est-il plausible ?',
      enonce:
