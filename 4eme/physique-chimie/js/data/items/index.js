...
//
// Un chapitre sur treize, sept savoir-faire sur 86 : les invariants de VOLUME
// (plancher de neuf items, couverture des savoir-faire, plafond global de
// classe C) mesureraient le vide sur les 79 autres. Le drapeau bascule quand le
// corpus est écrit, pas quand le premier chapitre l'est.
...
/** Les chapitres écrits, dans l'ordre de la progression. Un seul aujourd'hui. */
export const CHAPITRES_ECRITS = Object.freeze(['ch01-melanges-et-solubilite']);

export { ITEMS_CH01, ITEMS_EXEMPLES };
...
export const ITEMS = Object.freeze([...ITEMS_CH01, ...ITEMS_EXEMPLES]);
...
export const SAVOIR_FAIRE_ECRITS = Object.freeze([...SF_CH01]);
